...
import os
import sys
sys.path.insert(0, os.path.abspath('../Mensa-Auskunft/lambda/eu-west-1_MensaAuskunft_FLASK'))
...
htmlhelp_basename = 'Mensa-Auskunftdoc'
...
man_pages = [
    (master_doc, 'mensa-auskunft', 'Mensa-Auskunft Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Mensa-Auskunft', 'Mensa-Auskunft Documentation',
     author, 'Mensa-Auskunft', 'One line description of project.',
     'Miscellaneous'),
]
